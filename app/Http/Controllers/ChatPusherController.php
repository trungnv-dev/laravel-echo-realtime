...
class ChatPusherController extends Controller
{
    public function index()
    {
        ...
        return view('chat-pusher.index', compact('conversations'));
    }
    ...
    public function getMessages(Request $request)
    {
        ...
        $rs = view('chat-pusher.messages', ['messages' => $messages])->render();
    ...
    public function getConversations(Request $request)
    {
        ...
        $rs = view('chat-pusher.conversations', ['conversations' => $conversations, 'isActive' => $request->conversation_id])->render();
